...
\item Technical lead for SONIC (Services for Optimized Network Inference on Coprocessors) in the CMS software to accelerate ML inference using coprocessors as a service; consultant for other experiments (ATLAS, DUNE, IceCube, LIGO).
...
\item[FNAL AI Program Office Energy Frontier Research Group Leader] \hfill 2025 - present
\item[LHC Dark Showers Task Force CMS Representative] \hfill 2025 - present
