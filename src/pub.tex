...
\item J. Krupa, K. Lin, et al., ``Integrating GPU-based deep learning coprocessors into High Energy Physics workflows'', in progress.
\item \begin{sloppypar}G. Amadio et al., ``GeantV: Results from the prototype of concurrent vector particle transport simulation in HEP'', \href{https://arxiv.org/abs/2005.00949}{arXiv:2005.00949}, to be submitted to \emph{Comp. Soft. Big Sci.}.\end{sloppypar}
