...
\item K. Pedro, ``Current and Future Performance of the CMS Simulation'', \emph{submitted to Eur. Phys. J. Web. of Conf.} (2018).
\item N. Tran et al., ``FPGA-accelerated machine learning inference as a solution for particle physics computing challenges'', \emph{preprint in preparation} (2018).
\fi
