...
\item ``Computing resources and challenges''. US Muon Collider Collaboration Annual Meeting, University of Chicago, August 2025.
\item ``CMS Analysis: Dark QCD''. Physics analysis at the HL-LHC, an IRIS-HEP Blueprint Workshop, May 2025.
\item ``Computing resources and challenges''. International Muon Collider Collaboration Annual Meeting, DESY, May 2025.
\item ``Dark QCD: the Next Frontier in Dark Matter''. The $10^{\text{th}}$ LCTP Spring Symposium: Hunting for Particle Dark Matter, Ann Arbor, May 2025.
