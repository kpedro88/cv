...
\begin{description}[leftmargin=12pt,font=\normalfont,labelsep=0em]
\item \begin{sloppypar}``Search for light long-lived particles decaying to displaced jets in proton-proton collisions at $\sqrt{s} = 13.6$ TeV'', \href{https://arxiv.org/abs/2409.10806}{arXiv:2409.10806}, \href{https://dx.doi.org/10.1088/1361-6633/adaa13}{accepted by \emph{Rep. Prog. Phys.}}\end{sloppypar}
