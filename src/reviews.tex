...
\item ``Search for fractionally charged particles in pp collisions at $\sqrt{s} = 13\,\text{TeV}$'', \href{http://cds.cern.ch/record/2841994}{CMS-PAS-EXO-19-006}, November 2022.
...
\begin{description}[leftmargin=12pt,font=\normalfont,labelsep=0em]
\item ``Search for new physics in multijet events with at least one photon and large missing transverse momentum in proton-proton collisions at 13 TeV'', \href{http://cds.cern.ch/record/2852844}{CMS-PAS-SUS-21-009}, March 2023.
\item ``Measurement of the $\text{t}\overline{\text{t}}$ charge asymmetry in events with highly Lorentz-boosted top quarks in pp collisions at $\sqrt{s} = 13\,\text{TeV}$'', \href{https://arxiv.org/abs/2208.02751}{arXiv:2208.02751}, accepted by \emph{Phys. Lett. B}.
